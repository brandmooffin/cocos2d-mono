...
# Windows (WindowsDX)
dotnet run --project Tests/Cocos2DMono.IntegrationTests/Cocos2DMono.IntegrationTests.csproj -f net9.0-windows7.0
```

Android (`net9.0-android35.0`) and iOS (`net9.0-ios18.0`) build from the same project but
