...
namespace tests
{
    public class RenderTextureZbuffer : RenderTextureTestDemo
    {
        ...
        public RenderTextureZbuffer()
        {
            ...
            CCLabelTTF label = new CCLabelTTF("vertexZ = 50", "arial", 32);
            label.Position = new CCPoint(size.Width / 2, size.Height * 0.25f);
            AddChild(label);

            CCLabelTTF label2 = new CCLabelTTF("vertexZ = 0", "arial", 32);
            label2.Position = new CCPoint(size.Width / 2, size.Height * 0.5f);
            AddChild(label2);

            CCLabelTTF label3 = new CCLabelTTF("vertexZ = -50", "arial", 32);
