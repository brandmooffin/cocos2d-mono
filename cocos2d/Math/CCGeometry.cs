...
//        public float Angle
//        {
//            get { return (float)System.Math.Atan2(Y, X); }
//        }
...
//        {
//            CCPoint pt;
//            pt.X = (float)System.Math.Round(X);
//            pt.Y = (float)System.Math.Round(Y);
...
//            var angle = (float)System.Math.Atan2(a2.X * b2.Y - a2.Y * b2.X, Dot(a2, b2));
...
//        {
//            CCPoint r = v - pivot;
//            float cosa = (float)System.Math.Cos(angle), sina = (float)System.Math.Sin(angle);
//            float t = r.X;
...
//        {
//            CCPoint pt;
//            pt.X = (float)System.Math.Cos(a);
//            pt.Y = (float)System.Math.Sin(a);
//            return pt;
//        }
...
//            float x = p.X;
//            float y = p.Y;
//            float l = 1f / (float)System.Math.Sqrt(x * x + y * y);
//            CCPoint pt;
//            pt.X = x * l;
//            pt.Y = y * l;
//            return pt;
...
//            roundedUpRect.Size.Width = (float)(System.Math.Ceiling(roundedUpRect.Origin.X + roundedUpRect.Size.Width)
//                - System.Math.Floor(roundedUpRect.Origin.X));
//            roundedUpRect.Size.Height = (float)(System.Math.Ceiling(roundedUpRect.Origin.Y + roundedUpRect.Size.Height)
//                - System.Math.Floor(roundedUpRect.Origin.Y));
//            roundedUpRect.Origin.X = (float)System.Math.Floor(roundedUpRect.Origin.X);
//            roundedUpRect.Origin.Y = (float)System.Math.Floor(roundedUpRect.Origin.Y);
...
//        {
//            var x = System.Math.Min(value1.Origin.X, value2.Origin.X);
//            var y = System.Math.Min(value1.Origin.Y, value2.Origin.Y);
//            return new CCRect(x, y,
//                System.Math.Max(value1.MaxX, value2.MaxX) - x,
//                System.Math.Max(value1.MaxY, value2.MaxY) - y);
//        }

//        public static void Union(ref CCRect value1, ref CCRect value2, out CCRect result)
//        {
//            result.Origin.X = System.Math.Min(value1.Origin.X, value2.Origin.X);
//            result.Origin.Y = System.Math.Min(value1.Origin.Y, value2.Origin.Y);
//            result.Size.Width = System.Math.Max(value1.MaxX, value2.MaxX) - result.Origin.X;
//            result.Size.Height = System.Math.Max(value1.MaxY, value2.MaxY) - result.Origin.Y;
//        }
...
//    }
    ...
    public struct CCVector2 : IEquatable<CCVector2>
    {
        ...
        {
            return (float)System.Math.Atan2(value1.Y, value1.X);
        }
