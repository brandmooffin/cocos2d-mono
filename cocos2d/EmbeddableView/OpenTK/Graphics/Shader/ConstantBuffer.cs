using System;
using cocos2d.EmbeddableView.OpenTK.Graphics.Effect;
using Microsoft.Xna.Framework.Graphics;
using EffectParameter = cocos2d.EmbeddableView.OpenTK.Graphics.Effect.EffectParameter;
using EffectParameterCollection = cocos2d.EmbeddableView.OpenTK.Graphics.Effect.EffectParameterCollection;

namespace cocos2d.EmbeddableView.OpenTK.Graphics.Shader
{
