...
#if GLES
using GLPixelFormat = cocos2d.EmbeddableView.OpenTK.Graphics.ES20.PixelFormat;
using cocos2d.EmbeddableView.OpenTK.Graphics.ES20;
using cocos2d.EmbeddableView.OpenTK.Utilities;
#endif
                ...
                if (glFormat == (GLPixelFormat)All.CompressedTextureFormats)
                {
                    ...
                    switch (format)
                    {
                        ...
                        case SurfaceFormat.RgbaPvrtc2Bpp:
                            imageSize = (System.Math.Max(this.width, 16) * System.Math.Max(this.height, 8) * 2 + 7) / 8;
                            break;
                        case SurfaceFormat.RgbPvrtc4Bpp:
                        case SurfaceFormat.RgbaPvrtc4Bpp:
                            imageSize = (System.Math.Max(this.width, 8) * System.Math.Max(this.height, 8) * 4 + 7) / 8;
                            break;
            ...
            Threading.BlockOnUIThread(() =>
            {
                ...
                try
                {
                    ...
                    else
                    {
                        x = 0;
                        y = 0;
                        w = System.Math.Max(width >> level, 1);
                        h = System.Math.Max(height >> level, 1);
