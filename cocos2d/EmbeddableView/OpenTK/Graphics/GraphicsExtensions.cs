...
using VertexPointerType = cocos2d.EmbeddableView.OpenTK.Graphics.ES20.All;
using ColorPointerType = cocos2d.EmbeddableView.OpenTK.Graphics.ES20.All;
using NormalPointerType = cocos2d.EmbeddableView.OpenTK.Graphics.ES20.All;
using TexCoordPointerType = cocos2d.EmbeddableView.OpenTK.Graphics.ES20.All;
using cocos2d.EmbeddableView.OpenTK.Graphics.Vertices;
using Microsoft.Xna.Framework.Graphics;
using VertexElement = cocos2d.EmbeddableView.OpenTK.Graphics.Vertices.VertexElement;
using VertexElementUsage = cocos2d.EmbeddableView.OpenTK.Graphics.Vertices.VertexElementUsage;
#endif
#endif
...
namespace cocos2d.EmbeddableView.OpenTK.Graphics
{
    static class GraphicsExtensions
    {
            ...
            out PixelType glType)
        {
            ...
            var supportsSRgb = false;//graphicsDevice.GraphicsCapabilities.SupportsSRgb;
