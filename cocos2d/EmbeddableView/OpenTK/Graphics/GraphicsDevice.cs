...
using cocos2d.EmbeddableView.OpenTK.Graphics.Shader;
using cocos2d.EmbeddableView.OpenTK.Graphics.Vertices;
using Microsoft.Xna.Framework;
using Microsoft.Xna.Framework.Graphics;
using BlendState = cocos2d.EmbeddableView.OpenTK.Graphics.States.BlendState;
using DepthStencilState = cocos2d.EmbeddableView.OpenTK.Graphics.States.DepthStencilState;
using IndexBuffer = cocos2d.EmbeddableView.OpenTK.Graphics.Vertices.IndexBuffer;
using IVertexType = cocos2d.EmbeddableView.OpenTK.Graphics.Vertices.IVertexType;
using RasterizerState = cocos2d.EmbeddableView.OpenTK.Graphics.States.RasterizerState;
using VertexBuffer = cocos2d.EmbeddableView.OpenTK.Graphics.Vertices.VertexBuffer;
using VertexBufferBinding = cocos2d.EmbeddableView.OpenTK.Graphics.Vertices.VertexBufferBinding;
using VertexBufferBindings = cocos2d.EmbeddableView.OpenTK.Graphics.Vertices.VertexBufferBindings;
using VertexDeclaration = cocos2d.EmbeddableView.OpenTK.Graphics.Vertices.VertexDeclaration;
...
namespace cocos2d.EmbeddableView.OpenTK.Graphics
{
    public partial class GraphicsDevice : IDisposable
    {
        ...
        /// </summary>
        private Shader.Shader _vertexShader;
        ...
        /// </summary>
        private Shader.Shader _pixelShader;
        ...
        /// </summary>
        internal Dictionary<int, Microsoft.Xna.Framework.Graphics.Effect> EffectCache;
        ...
        private void Setup()
        {
            ...
            EffectCache = new Dictionary<int, Microsoft.Xna.Framework.Graphics.Effect>();
        }
        ...
        */
        ...
        internal Shader.Shader VertexShader
        {
        ...
        internal Shader.Shader PixelShader
        {
