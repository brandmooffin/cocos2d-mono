...
using Texture2D = cocos2d.EmbeddableView.OpenTK.Graphics.Texture2D;

namespace cocos2d.EmbeddableView.OpenTK.Utilities
{
    public class PngWriter
    {
        ...
        private int CalculateTotalVariation(byte[] input)
        {
            ...
            {
                totalVariation += System.Math.Abs(input[i] - input[i - 1]);
            }
