...
namespace TetrisGame.Core
{
	...
	public class ShapeS : Shape
	{
		...
		public ShapeS(Board board) : base(board, setBlocks(board), setOffsets())
		{ }
		...
		private static CCPoint[][] setOffsets()
		{
			...
			offsets[0] = new CCPoint[4] { new CCPoint(0, 0), new CCPoint(-1, -1), new CCPoint(2, 0), new CCPoint(1, -1) };
